...
const MentionsLegales: NextPage = () => {
  ...
  return (
    <div>
      ...
      /* -------------------------------------------------------------------------- */}
      <Head>
        <title>Mentions légales | Haftwald</title>
        <meta
          name="description"
          content="Prenez connaissance des mentions légales du site internet de Haftwald, développeur web freelance React, NextJS, Angular et Laravel."
        />
      </Head>
